...
import (
	...
	"greenlight.reandov.com/internal/data"
	"greenlight.reandov.com/internal/mailer"
	"greenlight.reandov.com/internal/vcs"
...
func main() {
	...
	flag.DurationVar(&cfg.db.maxIdleTime, "db-max-idle-time", 15*time.Minute, "Postgree max connection idle time")
